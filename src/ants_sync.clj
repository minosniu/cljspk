...
(defn evaporation-nosleep [x]
;  (when running
;    (send-off *agent* #'evaporation-nosleep))
  (evaporate)
  nil)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; use ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;demo
...
;(every animation-sleep-ms (partial send-off animator animation) thread-pool-neuron :fixed-delay true)
;(every animation-sleep-ms (partial send-off animator animation-nosleep) thread-pool-neuron)
(dorun (map #(send-off % behave) ants))
;(send-off evaporator evaporation)
(every evap-sleep-ms (partial send-off evaporator evaporation-nosleep) thread-pool-neuron)
